...
v, v_pred_sig_in_n_out = model.regnn.predict(X_v_in_n_out, samples=100)
U = model.project_to_U(v)
U_top = model.project_to_U(v + v_pred_sig_in_n_out)
U_pred_sig_in_n_out = np.abs(U_top - U)

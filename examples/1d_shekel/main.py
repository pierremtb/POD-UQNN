...
def main(hp, gen_test=False, use_cached_dataset=False,
    ...
    U_pred_hifi_mean[0] = model.restruct(U_pred_hifi_mean[0], no_s=True)
    U_pred_hifi_std[0] = model.restruct(U_pred_hifi_std[0], no_s=True)
    U_pred_hifi_mean[1] = model.restruct(U_pred_hifi_mean[1], no_s=True)
    U_pred_hifi_std[1] = model.restruct(U_pred_hifi_std[1], no_s=True)
